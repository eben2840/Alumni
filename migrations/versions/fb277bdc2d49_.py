...
revision = 'fb277bdc2d49'
down_revision = 'c7b2a78ab5c7'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('person', sa.Column('index', sa.String(length=10), nullable=True))
    ...
    op.create_unique_constraint(None, 'person', ['index'])
