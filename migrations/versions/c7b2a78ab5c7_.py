...
revision = 'c7b2a78ab5c7'
down_revision = 'a8f23014a3d4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('person', sa.Column('email', sa.String(length=200), nullable=True))
    op.add_column('person', sa.Column('faculty', sa.String(length=200), nullable=True))
    op.add_column('person', sa.Column('hallofresidence', sa.String(length=200), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'person', type_='unique')
    op.drop_constraint(None, 'person', type_='unique')
    op.drop_column('person', 'hallofresidence')
    op.drop_column('person', 'faculty')
